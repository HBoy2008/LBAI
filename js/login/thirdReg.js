...
mui.plusReady(function() {
	...
	//initOauth();
	storage.init();
	memo = appPage.getParam("memo");
	openid = appPage.getParam("openid");
	thirdpartyid = appPage.getParam("thirdpartyid");
	var imgurl = appPage.getParam("imgurl");
	var nickname = appPage.getParam("nickname");

	log("数据：" + imgurl + " " + nickname)
