	...
	document.getElementById("create").addEventListener("tap", function() {
		...
		mui.confirm('确认提交修改？', '', btnArray, function(e) {
			if(e.index == 1) {
				...
				log(cardList);
				//关闭页面
				mui.fire(plus.webview.getWebviewById("home/oneCardMeCreate.html"), "updataCardList", {
					CardTypeNum: CardTypeNum, //卡牌总数
					cardList: cardList //卡牌列表
				})
				mui.fire(plus.webview.getWebviewById("home/oneCardMeEdit.html"), "updataCardList", {
					CardTypeNum: CardTypeNum, //卡牌总数
					cardList: cardList //卡牌列表
				})
				var ws = plus.webview.currentWebview();
				plus.webview.close(ws);
				var xx = plus.webview.getWebviewById("home/addCard.html");
