...
mui.plusReady(function() {
		...
		mui.confirm('是否接受该场比赛', '', btnArray, function(e) {
			if(e.index == 1) {
				request("/Match/inviteMatchYorN", {
					...
					log(r);
					mui.toast(r.msg);
					//mui.fire(plus.webview.getWebviewById('customer/invitation.html'), 'uploadList');
					loadData();
				})
			}
		})
	...
	//		openNew("../mine/myMatch.html");
	//	})

	//关闭发起约战、预览约战页
	var _war = plus.webview.getWebviewById("customer/war.html");
